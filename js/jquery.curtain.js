...
(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        init: function () {
            ...
            this.$li = $(this.element).find('.cover');
        ...
        scrollEvent: function() {
            ...
            if(docTop < self.currentP && self.currentIndex > 0){
                ...
                self.$current.removeClass('current')
                    .addClass('hidden')
                    .next('.cover').addClass('current').next('.cover').removeClass('hidden');
        ...
        setDimensions: function(){
            ...
            this.$li.each(function(index) {
                var $self = $(this);
                cover = $self.hasClass('front-cover');
                ...
                if(cover){
                    ...
                    $self.css({height: height, zIndex: 999-index})
        ...
        setHash: function(hash){
            // "HARD FIX"
            el = $('[href=#'+hash+']');
            el.parent().siblings('.cover').removeClass('active');
