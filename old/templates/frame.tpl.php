...
<head>
	...
	<meta property="og:description" content="We are proud to announce the international Design for Experience (DfE) awards program. This program, operated in partnership with UX Magazine, recognizes people, teams, and companies that have achieved success in the design of user- and customer-centered products or services. Know of a company, individual, project, or product deserving of recognition? We welcome members of the community to recommend people and companies for an award." />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:site" content="@dfexp" />
	<meta name="twitter:title" content="Design for Experience Awards" />
	<meta name="twitter:description" content="The Design for Experience awards program, presented by UX Magazine, recognizes people, teams, and companies that achieve success in the design of user- and customer-centered products or services." />
...
<body itemscope itemtype="http://schema.org/Organization">
	...
	<script src="js/min/jquery-ui-1.10.3.custom.min"></script>
